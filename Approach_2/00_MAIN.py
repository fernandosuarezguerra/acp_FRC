...
res = minimize(mf.compute_desv_factor, x0, method='nelder-mead', args=(models_folder_path, x_target, y_target, path_oofem, path_oofem_extractor), options={'maxiter':200, 'maxfev':200}, bounds=bnds)
