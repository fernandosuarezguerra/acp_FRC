...
main_points = list(np.linspace(0,0.2,15))+list(np.linspace(0.4,1.5,15))
more_points = list(np.linspace(2.0,4.0,20))+list(np.linspace(8.0,10.0,15))
x_target = main_points + list(more_points) 

weights_main_points=1.0
weights_more_points=1.0
...
bnds = Bounds(lb = np.array((1.0e-4, 1.1e-2, 0.6, 4.50, 0.1, 0.1)), ub = np.array((1.0e-2, 0.5, 3.0, 15.0, 3.0, 3.0)), keep_feasible=True)
