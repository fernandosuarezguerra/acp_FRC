...
main_points = [0.15, 0.3, 3.0, 6.0]
more_points = np.linspace(0,10,100)
...
bnds = Bounds(lb = np.array((1.0e-4, 1.1e-2, 0.6, 4.50, 0.1, 0.1)), ub = np.array((1.0e-2, 0.5, 3.0, 10.0, 2.0, 2.0)), keep_feasible=True)
